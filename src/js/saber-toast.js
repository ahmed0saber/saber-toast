...
class SaberToast {
    ...
    success(params) {
        this.color = getComputedStyle(document.body).getPropertyValue("--success-clr")
    ...
    error(params) {
        this.color = getComputedStyle(document.body).getPropertyValue("--error-clr")
    ...
    warn(params) {
        this.color = getComputedStyle(document.body).getPropertyValue("--warn-clr")
    ...
    info(params) {
        this.color = getComputedStyle(document.body).getPropertyValue("--info-clr");
